...
impl<'a> Arbitrary<'a> for Abi {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(Abi {
            ...
            name: Some(Arbitrary::arbitrary(u)?),
        })
    }
}
#[cfg(any(feature = "derive", feature = "full"))]
...
impl<'a> Arbitrary<'a> for AngleBracketedGenericArguments {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(AngleBracketedGenericArguments {
            colon2_token: Some(Arbitrary::arbitrary(u)?),
...
impl<'a> Arbitrary<'a> for Arm {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(Arm {
            ...
            guard: Some((Arbitrary::arbitrary(u)?, Box::new(Arbitrary::arbitrary(u)?))),
            fat_arrow_token: Arbitrary::arbitrary(u)?,
            body: Box::new(Arbitrary::arbitrary(u)?),
            comma: Some(Arbitrary::arbitrary(u)?),
        })
    }
}
#[cfg(any(feature = "derive", feature = "full"))]
...
impl<'a> Arbitrary<'a> for BareFnArg {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(BareFnArg {
            attrs: Arbitrary::arbitrary(u)?,
            name: Some((
                Ident::new(Arbitrary::arbitrary(u)?, Span::call_site()),
...
impl<'a> Arbitrary<'a> for Binding {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(Binding {
            ident: Ident::new(Arbitrary::arbitrary(u)?, Span::call_site()),
...
impl<'a> Arbitrary<'a> for ConstParam {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(ConstParam {
            ...
            ty: Arbitrary::arbitrary(u)?,
            eq_token: Some(Arbitrary::arbitrary(u)?),
            default: Some(Arbitrary::arbitrary(u)?),
        })
    }
}
#[cfg(any(feature = "derive", feature = "full"))]
...
impl<'a> Arbitrary<'a> for DataStruct {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(DataStruct {
            ...
            semi_token: Some(Arbitrary::arbitrary(u)?),
        })
    }
}
#[cfg(feature = "derive")]
    ...
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok({
            ...
            match index {
                ...
                37u64 => Expr::Verbatim(quote::quote! {}),
...
impl<'a> Arbitrary<'a> for ExprAssign {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(ExprAssign {
            attrs: Arbitrary::arbitrary(u)?,
            left: Box::new(Arbitrary::arbitrary(u)?),
            eq_token: Arbitrary::arbitrary(u)?,
            right: Box::new(Arbitrary::arbitrary(u)?),
        })
    }
}
#[cfg(feature = "full")]
...
impl<'a> Arbitrary<'a> for ExprAsync {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(ExprAsync {
            ...
            capture: Some(Arbitrary::arbitrary(u)?),
...
impl<'a> Arbitrary<'a> for ExprAwait {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(ExprAwait {
            attrs: Arbitrary::arbitrary(u)?,
            base: Box::new(Arbitrary::arbitrary(u)?),
...
impl<'a> Arbitrary<'a> for ExprBlock {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(ExprBlock {
            attrs: Arbitrary::arbitrary(u)?,
            label: Some(Arbitrary::arbitrary(u)?),
            block: Arbitrary::arbitrary(u)?,
        })
    }
}
...
impl<'a> Arbitrary<'a> for ExprBox {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(ExprBox {
            ...
            expr: Box::new(Arbitrary::arbitrary(u)?),
        })
    }
}
#[cfg(feature = "full")]
...
impl<'a> Arbitrary<'a> for ExprBreak {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(ExprBreak {
            ...
            label: Some(Arbitrary::arbitrary(u)?),
            expr: Some(Box::new(Arbitrary::arbitrary(u)?)),
        })
    }
}
#[cfg(any(feature = "derive", feature = "full"))]
...
impl<'a> Arbitrary<'a> for ExprCall {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(ExprCall {
            attrs: Arbitrary::arbitrary(u)?,
            func: Box::new(Arbitrary::arbitrary(u)?),
...
impl<'a> Arbitrary<'a> for ExprCast {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(ExprCast {
            ...
            ty: Box::new(Arbitrary::arbitrary(u)?),
        })
    }
}
#[cfg(feature = "full")]
...
impl<'a> Arbitrary<'a> for ExprClosure {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(ExprClosure {
            attrs: Arbitrary::arbitrary(u)?,
            movability: Some(Arbitrary::arbitrary(u)?),
            asyncness: Some(Arbitrary::arbitrary(u)?),
            capture: Some(Arbitrary::arbitrary(u)?),
...
impl<'a> Arbitrary<'a> for ExprIf {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(ExprIf {
            ...
            cond: Box::new(Arbitrary::arbitrary(u)?),
            then_branch: Arbitrary::arbitrary(u)?,
            else_branch: Some((Arbitrary::arbitrary(u)?, Box::new(Arbitrary::arbitrary(u)?))),
        })
    }
}
#[cfg(any(feature = "derive", feature = "full"))]
...
impl<'a> Arbitrary<'a> for ExprIndex {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(ExprIndex {
            ...
            expr: Box::new(Arbitrary::arbitrary(u)?),
            bracket_token: Arbitrary::arbitrary(u)?,
            index: Box::new(Arbitrary::arbitrary(u)?),
        })
    }
}
#[cfg(feature = "full")]
...
impl<'a> Arbitrary<'a> for ExprMethodCall {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(ExprMethodCall {
            attrs: Arbitrary::arbitrary(u)?,
            receiver: Box::new(Arbitrary::arbitrary(u)?),
            dot_token: Arbitrary::arbitrary(u)?,
            method: Ident::new(Arbitrary::arbitrary(u)?, Span::call_site()),
            turbofish: Some(Arbitrary::arbitrary(u)?),
            paren_token: Arbitrary::arbitrary(u)?,
            args: Arbitrary::arbitrary(u)?,
        })
    }
...
impl<'a> Arbitrary<'a> for ExprPath {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(ExprPath {
            attrs: Arbitrary::arbitrary(u)?,
            qself: Some(Arbitrary::arbitrary(u)?),
            path: Arbitrary::arbitrary(u)?,
        })
    }
}
...
impl<'a> Arbitrary<'a> for ExprRange {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(ExprRange {
            attrs: Arbitrary::arbitrary(u)?,
            from: Some(Box::new(Arbitrary::arbitrary(u)?)),
            limits: Arbitrary::arbitrary(u)?,
            to: Some(Box::new(Arbitrary::arbitrary(u)?)),
        })
    }
}
#[cfg(feature = "full")]
...
impl<'a> Arbitrary<'a> for ExprReference {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(ExprReference {
            ...
            mutability: Some(Arbitrary::arbitrary(u)?),
            expr: Box::new(Arbitrary::arbitrary(u)?),
        })
    }
}
...
impl<'a> Arbitrary<'a> for ExprRepeat {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(ExprRepeat {
            ...
            len: Box::new(Arbitrary::arbitrary(u)?),
        })
    }
}
#[cfg(feature = "full")]
...
impl<'a> Arbitrary<'a> for ExprStruct {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(ExprStruct {
            ...
            brace_token: Arbitrary::arbitrary(u)?,
            fields: Arbitrary::arbitrary(u)?,
            dot2_token: Some(Arbitrary::arbitrary(u)?),
            rest: Some(Box::new(Arbitrary::arbitrary(u)?)),
        })
    }
}
#[cfg(feature = "full")]
...
impl<'a> Arbitrary<'a> for Field {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(Field {
            attrs: Arbitrary::arbitrary(u)?,
            vis: Arbitrary::arbitrary(u)?,
            ident: Some(Ident::new(Arbitrary::arbitrary(u)?, Span::call_site())),
            colon_token: Some(Arbitrary::arbitrary(u)?),
            ty: Arbitrary::arbitrary(u)?,
        })
    }
}
...
impl<'a> Arbitrary<'a> for FieldPat {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(FieldPat {
            ...
            member: Arbitrary::arbitrary(u)?,
            colon_token: Some(Arbitrary::arbitrary(u)?),
            pat: Box::new(Arbitrary::arbitrary(u)?),
        })
    }
}
#[cfg(feature = "full")]
...
impl<'a> Arbitrary<'a> for File {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(File {
            shebang: Some(Arbitrary::arbitrary(u)?),
            attrs: Arbitrary::arbitrary(u)?,
    ...
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok({
            ...
            match index {
                ...
                4u64 => ForeignItem::Verbatim(quote::quote! {}),
                _ => unreachable!(),
            }
        })
    }
...
impl<'a> Arbitrary<'a> for Generics {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(Generics {
            lt_token: Some(Arbitrary::arbitrary(u)?),
            params: Arbitrary::arbitrary(u)?,
            gt_token: Some(Arbitrary::arbitrary(u)?),
            where_clause: Some(Arbitrary::arbitrary(u)?),
        })
    }
}
#[cfg(feature = "full")]
    ...
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok({
            ...
            match index {
                ...
                4u64 => ImplItem::Verbatim(quote::quote! {}),
                _ => unreachable!(),
            }
        })
    }
...
impl<'a> Arbitrary<'a> for ImplItemConst {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(ImplItemConst {
            attrs: Arbitrary::arbitrary(u)?,
            vis: Arbitrary::arbitrary(u)?,
            defaultness: Some(Arbitrary::arbitrary(u)?),
            const_token: Arbitrary::arbitrary(u)?,
            ident: Ident::new(Arbitrary::arbitrary(u)?, Span::call_site()),
            colon_token: Arbitrary::arbitrary(u)?,
            ty: Arbitrary::arbitrary(u)?,
    ...
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok({
            ...
            match index {
                ...
                16u64 => Item::Verbatim(quote::quote! {}),
                _ => unreachable!(),
            }
        })
    }
...
impl<'a> Arbitrary<'a> for ItemFn {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(ItemFn {
            ...
            vis: Arbitrary::arbitrary(u)?,
            sig: Arbitrary::arbitrary(u)?,
            block: Box::new(Arbitrary::arbitrary(u)?),
        })
    }
}
#[cfg(feature = "full")]
...
impl<'a> Arbitrary<'a> for ItemImpl {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(ItemImpl {
            attrs: Arbitrary::arbitrary(u)?,
            defaultness: Some(Arbitrary::arbitrary(u)?),
            unsafety: Some(Arbitrary::arbitrary(u)?),
            ...
            self_ty: Box::new(Arbitrary::arbitrary(u)?),
            brace_token: Arbitrary::arbitrary(u)?,
            items: Arbitrary::arbitrary(u)?,
        })
    }
...
impl<'a> Arbitrary<'a> for ItemMod {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(ItemMod {
            ...
            ident: Ident::new(Arbitrary::arbitrary(u)?, Span::call_site()),
            content: Some((Arbitrary::arbitrary(u)?, Arbitrary::arbitrary(u)?)),
            semi: Some(Arbitrary::arbitrary(u)?),
        })
    }
}
#[cfg(feature = "full")]
...
impl<'a> Arbitrary<'a> for ItemTrait {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(ItemTrait {
            ...
            vis: Arbitrary::arbitrary(u)?,
            unsafety: Some(Arbitrary::arbitrary(u)?),
            auto_token: Some(Arbitrary::arbitrary(u)?),
...
impl<'a> Arbitrary<'a> for ItemUse {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(ItemUse {
            ...
            leading_colon: Some(Arbitrary::arbitrary(u)?),
...
impl<'a> Arbitrary<'a> for Local {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(Local {
            ...
            let_token: Arbitrary::arbitrary(u)?,
            pat: Arbitrary::arbitrary(u)?,
            init: Some((Arbitrary::arbitrary(u)?, Box::new(Arbitrary::arbitrary(u)?))),
            semi_token: Arbitrary::arbitrary(u)?,
        })
    }
}
...
impl<'a> Arbitrary<'a> for Member {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok({
            let index = (u64::from(u32::arbitrary(u)?) * 2u64) >> 32;
            match index {
                0u64 => Member::Named(Ident::new(Arbitrary::arbitrary(u)?, Span::call_site())),
    ...
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok({
            ...
            match index {
                ...
                14u64 => Pat::Verbatim(quote::quote! {}),
...
impl<'a> Arbitrary<'a> for PatIdent {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(PatIdent {
            attrs: Arbitrary::arbitrary(u)?,
            by_ref: Some(Arbitrary::arbitrary(u)?),
            mutability: Some(Arbitrary::arbitrary(u)?),
            ident: Ident::new(Arbitrary::arbitrary(u)?, Span::call_site()),
            subpat: Some((Arbitrary::arbitrary(u)?, Box::new(Arbitrary::arbitrary(u)?))),
        })
    }
}
#[cfg(feature = "full")]
...
impl<'a> Arbitrary<'a> for PatOr {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(PatOr {
            attrs: Arbitrary::arbitrary(u)?,
            leading_vert: Some(Arbitrary::arbitrary(u)?),
...
impl<'a> Arbitrary<'a> for PatRange {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(PatRange {
            attrs: Arbitrary::arbitrary(u)?,
            lo: Box::new(Arbitrary::arbitrary(u)?),
            limits: Arbitrary::arbitrary(u)?,
            hi: Box::new(Arbitrary::arbitrary(u)?),
        })
    }
}
#[cfg(feature = "full")]
...
impl<'a> Arbitrary<'a> for PredicateType {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(PredicateType {
            lifetimes: Some(Arbitrary::arbitrary(u)?),
...
impl<'a> Arbitrary<'a> for QSelf {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(QSelf {
            ...
            as_token: Some(Arbitrary::arbitrary(u)?),
            gt_token: Arbitrary::arbitrary(u)?,
        })
    }
}
...
impl<'a> Arbitrary<'a> for Receiver {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(Receiver {
            attrs: Arbitrary::arbitrary(u)?,
            reference: Some((Arbitrary::arbitrary(u)?, Some(Arbitrary::arbitrary(u)?))),
            mutability: Some(Arbitrary::arbitrary(u)?),
    ...
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok({
            ...
            match index {
                ...
                1u64 => {
                    ReturnType::Type(Arbitrary::arbitrary(u)?, Box::new(Arbitrary::arbitrary(u)?))
                }
                _ => unreachable!(),
            }
        })
...
impl<'a> Arbitrary<'a> for Signature {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(Signature {
            constness: Some(Arbitrary::arbitrary(u)?),
            asyncness: Some(Arbitrary::arbitrary(u)?),
            unsafety: Some(Arbitrary::arbitrary(u)?),
            abi: Some(Arbitrary::arbitrary(u)?),
            fn_token: Arbitrary::arbitrary(u)?,
            ident: Ident::new(Arbitrary::arbitrary(u)?, Span::call_site()),
            generics: Arbitrary::arbitrary(u)?,
            paren_token: Arbitrary::arbitrary(u)?,
            inputs: Arbitrary::arbitrary(u)?,
            variadic: Some(Arbitrary::arbitrary(u)?),
            output: Arbitrary::arbitrary(u)?,
        })
    }
}
...
impl<'a> Arbitrary<'a> for TraitBound {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(TraitBound {
            paren_token: Some(Arbitrary::arbitrary(u)?),
    ...
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok({
            ...
            match index {
                ...
                4u64 => TraitItem::Verbatim(quote::quote! {}),
                _ => unreachable!(),
            }
        })
    }
...
impl<'a> Arbitrary<'a> for TraitItemConst {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(TraitItemConst {
            ...
            colon_token: Arbitrary::arbitrary(u)?,
            ty: Arbitrary::arbitrary(u)?,
            default: Some((Arbitrary::arbitrary(u)?, Arbitrary::arbitrary(u)?)),
            semi_token: Arbitrary::arbitrary(u)?,
        })
    }
}
    ...
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok({
            ...
            match index {
                ...
                14u64 => Type::Verbatim(quote::quote! {}),
                _ => unreachable!(),
            }
        })
    }
...
impl<'a> Arbitrary<'a> for TypeArray {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(TypeArray {
            bracket_token: Arbitrary::arbitrary(u)?,
            elem: Box::new(Arbitrary::arbitrary(u)?),
            semi_token: Arbitrary::arbitrary(u)?,
...
impl<'a> Arbitrary<'a> for TypePtr {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(TypePtr {
            ...
            const_token: Some(Arbitrary::arbitrary(u)?),
            mutability: Some(Arbitrary::arbitrary(u)?),
            elem: Box::new(Arbitrary::arbitrary(u)?),
        })
    }
...
impl<'a> Arbitrary<'a> for TypeReference {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(TypeReference {
            and_token: Arbitrary::arbitrary(u)?,
            lifetime: Some(Arbitrary::arbitrary(u)?),
            mutability: Some(Arbitrary::arbitrary(u)?),
            elem: Box::new(Arbitrary::arbitrary(u)?),
        })
    }
...
impl<'a> Arbitrary<'a> for TypeTraitObject {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(TypeTraitObject {
            dyn_token: Some(Arbitrary::arbitrary(u)?),
            bounds: Arbitrary::arbitrary(u)?,
        })
    }
}
...
impl<'a> Arbitrary<'a> for UsePath {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(UsePath {
            ident: Ident::new(Arbitrary::arbitrary(u)?, Span::call_site()),
            colon2_token: Arbitrary::arbitrary(u)?,
            tree: Box::new(Arbitrary::arbitrary(u)?),
        })
    }
}
#[cfg(feature = "full")]
...
impl<'a> Arbitrary<'a> for UseRename {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(UseRename {
            ident: Ident::new(Arbitrary::arbitrary(u)?, Span::call_site()),
            as_token: Arbitrary::arbitrary(u)?,
            rename: Ident::new(Arbitrary::arbitrary(u)?, Span::call_site()),
        })
    }
}
#[cfg(feature = "full")]
...
impl<'a> Arbitrary<'a> for Variant {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(Variant {
            ...
            ident: Ident::new(Arbitrary::arbitrary(u)?, Span::call_site()),
            fields: Arbitrary::arbitrary(u)?,
            discriminant: Some((Arbitrary::arbitrary(u)?, Arbitrary::arbitrary(u)?)),
        })
    }
}
#[cfg(any(feature = "derive", feature = "full"))]
...
impl<'a> Arbitrary<'a> for VisRestricted {
    fn arbitrary(u: &mut Unstructured<'a>) -> arbitrary::Result<Self> {
        Ok(VisRestricted {
            pub_token: Arbitrary::arbitrary(u)?,
            paren_token: Arbitrary::arbitrary(u)?,
            in_token: Some(Arbitrary::arbitrary(u)?),
            path: Box::new(Arbitrary::arbitrary(u)?),
        })
    }
}
#[cfg(any(feature = "derive", feature = "full"))]
